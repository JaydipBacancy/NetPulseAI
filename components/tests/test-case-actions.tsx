...
const inlineControlClassName =
  "h-9 min-w-[7rem] rounded-xl border border-border/70 bg-card/92 px-2 py-1 text-xs text-foreground shadow-[0_10px_24px_-20px_rgba(15,23,42,0.16)] transition-colors [color-scheme:light] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60";
